...
public class SpareTheSympathyClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		// Signs formatted as [STS] / <build id> post their link to chat when clicked.
		SignLinkHandler.register();
		...
		// Sends the optional /buildstealer2000 taunt once its delay passes.
		ClientTickEvents.END_CLIENT_TICK.register(client -> BuildStealerCommand.onClientTick());
	}
}
